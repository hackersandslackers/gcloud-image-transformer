...
class StandardImageTransformer(BaseImageTransformer):
    ...
    def __init__(self, bucket, bucket_name, bucket_url, retina_images):
        ...
        self.standard_images_generated = []
        self.bucket = bucket
    ...
    def transform(self):
        ...
        for image_blob in self.retina_images:
            if '@2x' in image_blob:
                new_image_name = image_blob.replace('@2x', '')
